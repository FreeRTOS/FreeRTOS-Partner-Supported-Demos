...
#define configSTART_GENERIC_QUEUE_TESTS           1 /* configRUN_MULTIPLE_PRIORITIES = 0 */
#define configSTART_PEEK_QUEUE_TESTS              1 /* configRUN_MULTIPLE_PRIORITIES = 0 */
#define configSTART_INTEGER_MATH_TESTS            0
#define configSTART_MATH_TESTS                    0
#define configSTART_RECURSIVE_MUTEX_TESTS         1 /* configRUN_MULTIPLE_PRIORITIES = 0 */
...
#define configSTART_EVENT_GROUP_TESTS             1 /* configRUN_MULTIPLE_PRIORITIES = 0 */
#define configSTART_INTERRUPT_SEMAPHORE_TESTS     1 /* configRUN_MULTIPLE_PRIORITIES = 0 */
...
#define configSTART_TIMER_TESTS                   1 /* configRUN_MULTIPLE_PRIORITIES = 0 */
