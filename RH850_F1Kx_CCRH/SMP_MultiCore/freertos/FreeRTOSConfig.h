...
#define configSTART_GENERIC_QUEUE_TESTS              0 /* set configRUN_MULTIPLE_PRIORITIES = 0 */
#define configSTART_PEEK_QUEUE_TESTS                 0 /* set configRUN_MULTIPLE_PRIORITIES = 0 */
...
#define configSTART_EVENT_GROUP_TESTS                0 /* set configRUN_MULTIPLE_PRIORITIES = 0 */
#define configSTART_INTERRUPT_SEMAPHORE_TESTS        0 /* set configRUN_MULTIPLE_PRIORITIES = 0 */
...
#define configSTART_STREAM_BUFFER_TESTS              0 /* Couldn't allocate enough memory to create task */
#define configSTART_STREAM_BUFFER_INTERRUPT_TESTS    0
#define configSTART_TIMER_TESTS                      0 /* set configRUN_MULTIPLE_PRIORITIES = 0 */
#define configSTART_INTERRUPT_QUEUE_TESTS            0 /* Ignored this test is not implemented */
#define configSTART_REGISTER_TESTS                   0
#define configSTART_DELETE_SELF_TESTS                0


void vTaskAssert( char str[],
                  uint32_t line );
#define configASSERT( x )    if( ( x ) == 0 ) { vTaskAssert( __FILE__, __LINE__ ); }
