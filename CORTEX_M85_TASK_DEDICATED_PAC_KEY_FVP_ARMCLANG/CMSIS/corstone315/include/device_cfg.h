...
/* ARM MPC SIE 315 driver structures */
#ifdef RTE_VM0_MPC
    #define MPC_VM0_S
...
#ifdef RTE_MAIN0_PPC_CORSTONE315
    #define PPC_CORSTONE315_MAIN0_S
    #define PPC_CORSTONE315_MAIN0_DEV    PPC_CORSTONE315_MAIN0_DEV_S
#endif
#ifdef RTE_MAIN_EXP0_PPC_CORSTONE315
    #define PPC_CORSTONE315_MAIN_EXP0_S
    #define PPC_CORSTONE315_MAIN_EXP0_DEV    PPC_CORSTONE315_MAIN_EXP0_DEV_S
#endif
#ifdef RTE_MAIN_EXP1_PPC_CORSTONE315
    #define PPC_CORSTONE315_MAIN_EXP1_S
    #define PPC_CORSTONE315_MAIN_EXP1_DEV    PPC_CORSTONE315_MAIN_EXP1_DEV_S
#endif
#ifdef RTE_MAIN_EXP2_PPC_CORSTONE315
    #define PPC_CORSTONE315_MAIN_EXP2_S
    #define PPC_CORSTONE315_MAIN_EXP2_DEV    PPC_CORSTONE315_MAIN_EXP2_DEV_S
#endif
#ifdef RTE_MAIN_EXP3_PPC_CORSTONE315
    #define PPC_CORSTONE315_MAIN_EXP3_S
    #define PPC_CORSTONE315_MAIN_EXP3_DEV    PPC_CORSTONE315_MAIN_EXP3_DEV_S
#endif
#ifdef RTE_PERIPH0_PPC_CORSTONE315
    #define PPC_CORSTONE315_PERIPH0_S
    #define PPC_CORSTONE315_PERIPH0_DEV    PPC_CORSTONE315_PERIPH0_DEV_S
#endif
#ifdef RTE_PERIPH1_PPC_CORSTONE315
    #define PPC_CORSTONE315_PERIPH1_S
    #define PPC_CORSTONE315_PERIPH1_DEV    PPC_CORSTONE315_PERIPH1_DEV_S
#endif
#ifdef RTE_PERIPH_EXP0_PPC_CORSTONE315
    #define PPC_CORSTONE315_PERIPH_EXP0_S
    #define PPC_CORSTONE315_PERIPH_EXP0_DEV    PPC_CORSTONE315_PERIPH_EXP0_DEV_S
#endif
#ifdef RTE_PERIPH_EXP1_PPC_CORSTONE315
    #define PPC_CORSTONE315_PERIPH_EXP1_S
    #define PPC_CORSTONE315_PERIPH_EXP1_DEV    PPC_CORSTONE315_PERIPH_EXP1_DEV_S
#endif
#ifdef RTE_PERIPH_EXP2_PPC_CORSTONE315
    #define PPC_CORSTONE315_PERIPH_EXP2_S
    #define PPC_CORSTONE315_PERIPH_EXP2_DEV    PPC_CORSTONE315_PERIPH_EXP2_DEV_S
#endif
#ifdef RTE_PERIPH_EXP3_PPC_CORSTONE315
    #define PPC_CORSTONE315_PERIPH_EXP3_S
    #define PPC_CORSTONE315_PERIPH_EXP3_DEV    PPC_CORSTONE315_PERIPH_EXP3_DEV_S
#endif
