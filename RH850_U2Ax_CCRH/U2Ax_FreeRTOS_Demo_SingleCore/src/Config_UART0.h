...
* Macro definitions
***********************************************************************************************************************/
    #define _UART0_BAUD_RATE_PRESCALER    ( 28U )
    #define _UART_MAX_TRANSFER_SIZE       ( 2048 )
    #ifndef __TYPEDEF__
        #define DI()           __DI()
        #define EI()           __EI()
        #define HALT()         __halt()
...
/* Error list definition */
    ...
    #define MD_BUSY                     ( MD_ERRORBASE + 0x02U ) /* error busy peripheral */
    #define MD_OVF                      ( MD_ERRORBASE + 0x03U ) /* error buffer overflow */
...
/* Clock CLKC_HSB */
    #define _CLOCK_CLKC_HSB                 ( 1U )
    #define _MODULE_STANDBY_DISABLE         ( 0U )
...
#endif /* ifndef CFG_Config_UART0_H */
