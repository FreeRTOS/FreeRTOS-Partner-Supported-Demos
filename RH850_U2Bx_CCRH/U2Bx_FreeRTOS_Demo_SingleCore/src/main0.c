...
void main_PE2(void);
extern void setup_PE2_EIC0();
#define PE2EIC0              (0xfffcc002)
#endif
...
void setup_PE2_EIC0 (void)
{
    volatile uint16_t * pPE2EIC0RegAddr;
    
    pPE2EIC0RegAddr = (volatile uint16_t *) PE2EIC0;
    /* Initial Interrupt Vector Method and Enable Interrupt */
    *pPE2EIC0RegAddr = 0x8001;
}
#endif
...
void Guard_Init(void)
{
  ...
  PEGKCPROT_PE0 = 0xA5A5A501UL;
  PEGKCPROT_PE1 = 0xA5A5A501UL;
  PEGKCPROT_PE2 = 0xA5A5A501UL;

  PEGPROT0(0) |= 0x00000153UL;
  PEGPROT0(1) |= 0x00000153UL;
  PEGPROT0(2) |= 0x00000153UL;
  PEGPROT0(3) |= 0x00000153UL;
  PEGPROT0(4) |= 0x00000153UL;
  PEGPROT0(5) |= 0x00000153UL;
  PEGPROT0(6) |= 0x00000153UL;
  PEGPROT0(7) |= 0x00000153UL;

  PEGPROT1(0) |= 0x00000153UL;
  PEGPROT1(1) |= 0x00000153UL;
  PEGPROT1(2) |= 0x00000153UL;
  PEGPROT1(3) |= 0x00000153UL;
  PEGPROT1(4) |= 0x00000153UL;
  PEGPROT1(5) |= 0x00000153UL;
  PEGPROT1(6) |= 0x00000153UL;
  PEGPROT1(7) |= 0x00000153UL;

  PEGPROT2(0) |= 0x00000153UL;
  PEGPROT2(1) |= 0x00000153UL;
  PEGPROT2(2) |= 0x00000153UL;
  PEGPROT2(3) |= 0x00000153UL;
  PEGPROT2(4) |= 0x00000153UL;
  PEGPROT2(5) |= 0x00000153UL;
  PEGPROT2(6) |= 0x00000153UL;
  PEGPROT2(7) |= 0x00000153UL;

  PEGKCPROT_PE0 = 0xA5A5A500UL;
  PEGKCPROT_PE1 = 0xA5A5A500UL;
  PEGKCPROT_PE2 = 0xA5A5A500UL;
