# RH850 U2Bx FreeRTOS Partner Supported Demo with CC-RH Compiler

## Introduction
This directory contains demo project for Renesas RH850 U2B6 using the CC-RH compiler.<br />
...
```c
RESET,STARTUP_CODE_PE0,STARTUP_CODE_PEn,STARTUP_CODE/00000000,ex_entry_PE0/00001000,ex_entry_PE1/00001400,ex_entry_PE2/00001800,.const,.INIT_BSEC.const,.INIT_DSEC.const,.data,.text/00004000,.inttable_PE0.const/00040000,.inttable_PE1.const/00041000,.inttable_PE2.const/00042000,.stack.bss/FDC00000,.stack_pe1.bss/FDA00000,.stack_pe2.bss/FD800000,.data.R,.bss,.mev_address.bss/FE000000
```
