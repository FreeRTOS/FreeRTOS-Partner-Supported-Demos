...
;------------------------------------------------------------------------------
;------------ This is used for sync between other core
;------------------------------------------------------------------------------
  ;.extern ___board_devices_init
;___board_devices_init:
...
_RESET_PE0:
  ...
  ; FXU system register
  mov     0x00030020, r10 ; set 1 in PSW.CU1 for writing FXU Function Register
                          ; set 1 in PSW.ID for prohibiting EI-level interrupt
  ldsr    r10, 5, 0       ; SR5,0  PSW
  mov     0x00220000, r10 ; set 1 in FXSR.FS
  ldsr    r10, 6, 10      ; SR6,10  FXSR
  ldsr    r0,  8, 10       ; SR8,10  FXST
  ldsr    r0,  12, 10       ; SR12,10  FXXC
  ldsr    r0,  13, 10       ; SR13,10  FXXP
